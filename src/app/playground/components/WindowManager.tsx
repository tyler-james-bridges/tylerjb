...
const WindowManager = forwardRef<WindowManagerRef>(
  function WindowManager(props, ref) {
        ...
        content: (
          <div className="p-4">
            ...
            <p className="text-sm text-gray-600">
              Try dragging windows around, opening applications, and exploring
              the OS!
            </p>
    ...
    const openApp = (appType: string) => {
      ...
      const mobileHeight = isMobile
        ? Math.min(window.innerHeight - 120, 500)
        : 0;
      ...
      const apps: Record<string, Omit<AppWindow, 'id' | 'zIndex'>> = {
        terminal: {
          ...
          content: <Terminal />,
          position: {
            x: isMobile ? mobileOffset : 150,
            y: isMobile ? mobileOffset : 120,
          },
          size: {
            width: isMobile ? mobileWidth : 600,
            height: isMobile ? mobileHeight : 400,
          },
          isMinimized: false,
          isMaximized: false,
        },
        texteditor: {
          ...
          position: {
            ...
            y: isMobile ? mobileOffset : 100,
          },
          size: {
            width: isMobile ? mobileWidth : 700,
            height: isMobile ? mobileHeight : 500,
          },
          isMinimized: false,
          isMaximized: false,
        },
        about: {
          ...
          content: <AboutMe />,
          position: {
            x: isMobile ? mobileOffset : 250,
            y: isMobile ? mobileOffset : 80,
          },
          size: {
            width: isMobile ? mobileWidth : 600,
        ...
        bughunter: {
          ...
          content: <BugHunter />,
          position: {
            x: isMobile ? mobileOffset : 100,
            y: isMobile ? mobileOffset : 60,
          },
          size: {
        ...
        music: {
          ...
          size: {
            width: isMobile ? mobileWidth : 900,
            height: isMobile ? mobileHeight : 650,
          },
          isMinimized: false,
          isMaximized: false,
        },
        soundstudio: {
          ...
          size: {
            width: isMobile ? mobileWidth : 500,
            height: isMobile ? mobileHeight : 550,
          },
          isMinimized: false,
          isMaximized: false,
