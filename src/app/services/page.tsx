      ...
      <section className="relative min-h-[40vh] flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-white max-w-3xl mx-auto mb-6">
            Professional websites that grow your business. From concept to launch, I handle everything.
          </p>
          <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-4 max-w-3xl mx-auto">
            <p className="text-neutral-300 font-medium text-center">
              Agency quality at freelancer prices with <span className="text-white font-semibold">unlimited revisions</span>.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-6">
            ...
            <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-700 rounded-2xl p-6 hover:border-teal-400/50 transition-all duration-300 flex flex-col">
              <div className="text-center mb-4 h-24">
                ...
                <p className="text-neutral-400 text-sm">Perfect for product launches & campaigns</p>
              </div>

              <div className="text-center mb-6 h-20">
                <div className="mb-2">
                  <span className="text-neutral-500 line-through text-sm">Market: $2,000-$3,500</span>
                </div>
              ...
              <div className="space-y-2 mb-6 flex-grow">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-neutral-300 text-sm">Responsive design (mobile/tablet/desktop)</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Contact form with email notifications</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Google Analytics & Search Console setup</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">SEO optimization & meta tags</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">SSL certificate & hosting setup</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Fast loading speed optimization</span>
                </div>
              </div>
            ...
            <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-700 rounded-2xl p-6 hover:border-teal-400/50 transition-all duration-300 flex flex-col">
              <div className="text-center mb-4 h-24 flex flex-col justify-end">
                ...
                <p className="text-neutral-400 text-sm">Advanced features & integrations</p>
              </div>

              <div className="text-center mb-6 h-20">
                <div className="mb-2">
                  <span className="text-neutral-500 line-through text-sm">Market: $3,500-$5,000</span>
                </div>
              ...
              <div className="space-y-2 mb-6 flex-grow">
                <h3 className="text-white font-semibold mb-3 text-sm">Everything in Basic plus:</h3>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">CRM integration (HubSpot, Salesforce)</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Marketing automation setup</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Conversion tracking & heatmaps</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Custom animations & interactions</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Live chat integration</span>
                </div>
              </div>
            ...
            <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-700 rounded-2xl p-6 hover:border-green-400/50 transition-all duration-300 flex flex-col">
              <div className="text-center mb-4 h-24 flex flex-col justify-end">
                ...
                <p className="text-neutral-400 text-sm">Complete online presence (5-8 pages)</p>
              </div>

              <div className="text-center mb-6 h-20">
                <div className="mb-2">
                  <span className="text-neutral-500 line-through text-sm">Market: $5,000-$10,000</span>
                </div>
              ...
              <div className="space-y-2 mb-6 flex-grow">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-neutral-300 text-sm">5-8 custom designed pages</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Content Management System (CMS)</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Blog functionality</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Social media integration</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Google My Business optimization</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-neutral-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-300 text-sm">Basic training included</span>
                </div>
              </div>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-neutral-900/30 backdrop-blur-sm border border-neutral-600 rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-bold text-white">Website Maintenance</h3>
              ...
              <div className="mb-4">
                <div className="text-neutral-500 line-through text-sm mb-1">Market: $200-$500/month</div>
                <div className="text-2xl font-bold text-white">$75-$199<span className="text-sm text-neutral-400">/month</span></div>
              </div>
              <p className="text-neutral-300 text-sm mb-4">Keep your site secure, updated, and running smoothly</p>
            ...
            <div className="bg-neutral-900/30 backdrop-blur-sm border border-neutral-600 rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-bold text-white">E-commerce Setup</h3>
                <svg className="w-6 h-6 text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mb-4">
                <div className="text-neutral-500 line-through text-sm mb-1">Market: $3,000-$8,000</div>
                <div className="text-2xl font-bold text-white">$1,200</div>
              </div>
              <p className="text-neutral-300 text-sm mb-4">Complete online store with payment processing</p>
              <div className="space-y-1 text-xs text-neutral-400">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-2">We Talk</h3>
                <p className="text-neutral-300">Tell me about your business goals and what you need your website to do.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-2">I Build</h3>
                <p className="text-neutral-300">Your website is custom-built from scratch with your specific needs in mind.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-2">You Review</h3>
                <p className="text-neutral-300">See your website in action and request any changes you need.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-2">We Launch</h3>
                <p className="text-neutral-300">Your website goes live with ongoing support to ensure everything runs smoothly.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-neutral-900/30 p-6 rounded-xl">
              <h3 className="text-xl font-semibold text-white mb-3">No Templates</h3>
              <p className="text-neutral-300">Every website is built from scratch, designed specifically for your business needs.</p>
            </div>
            <div className="bg-neutral-900/30 p-6 rounded-xl">
              <h3 className="text-xl font-semibold text-white mb-3">Fast & Reliable</h3>
              <p className="text-neutral-300">Modern technology ensures your site loads quickly and works perfectly every time.</p>
            </div>
            <div className="bg-neutral-900/30 p-6 rounded-xl">
              <h3 className="text-xl font-semibold text-white mb-3">Mobile-First</h3>
              <p className="text-neutral-300">Your site will look great and work flawlessly on phones, tablets, and computers.</p>
            </div>
            <div className="bg-neutral-900/30 p-6 rounded-xl">
      ...
      <section className="py-16 px-6 bg-gradient-to-b from-neutral-900 to-neutral-950">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() => window.location.href = `mailto:${['tylerjames', 'bridges', '@', 'gmail.com'].join('')}`}
